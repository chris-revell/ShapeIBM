...
// hg is a mesh width.                                                 //
//---------------------------------------------------------------------//
void NavierStokes(cube& ug,cube& vg,const cube& fg,const mat& sg,const float& Ng,const float& mu,const float& rho,const float& hg,const float& dt){
